 ...
 */
package mobi.cyann.deviltools.services;
...
public class ObserverService extends Service {
	private final static String LOG_TAG = "DevilTools.ObserverService";
	...
	public static void startService(Context context, boolean forced) {
		...
		boolean startService = preferences.getBoolean(context.getString(R.string.key_deviltools_service), false);
