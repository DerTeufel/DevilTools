...
import mobi.cyann.deviltools.preference.BasePreference;
import mobi.cyann.deviltools.preference.RemovablePreferenceCategory;
...
public class BasePreferenceFragment extends PreferenceListFragment implements OnPreferenceAttachedListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getActivity().registerReceiver(reloadListener, new IntentFilter("mobi.cyann.deviltools.RELOAD"));
	}
