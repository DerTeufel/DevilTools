...
public class FileSelectPreference extends ListPreference {
	...
	public FileSelectPreference(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.mobi_cyann_deviltools_preference_FileSelectPreference);
		path = a.getString(R.styleable.mobi_cyann_deviltools_preference_FileSelectPreference_path);
		a.recycle();
	}
